                     ...
                     <div class="option_container">
                        <div class="options">
                           <form action="{{ url('add_cart',$product->id) }}" method="Post">
                              @csrf
                              <input type="number" name="quantity" value="1" min="1" class="option1" style="background-color:white;color:black;font-size:1.5rem;font-weight:700;"><br>
                             <input type="submit" class="option1" value="Add To Card">
                           </form>
